          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-invert prose-purple max-w-none">
              ...
              <ScrollFade>
                <h2>Our Team</h2>
                <p>
                  NeuralPulse is run by a team of AI researchers, engineers, and enthusiasts who are passionate about
                  the potential of artificial intelligence to transform our world for the better.
                </p>
              </ScrollFade>
