                ...
                <FadeIn>
                  <h1 className="text-4xl md:text-6xl font-bold leading-tight">
                    ...
                    <span className="text-purple-500">
                      <TypingText text=" Bonk" delay={500} />
                    </span>
                  </h1>
                </FadeIn>
                <FadeIn delay={0.3}>
          ...
          <section className="mb-20">
            <ScrollFade>
              <div className="bg-gray-900 rounded-xl p-8">
                <h2 className="text-2xl font-bold mb-6 text-center">NeuralPulse Impact</h2>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                  ...
                  <div className="space-y-2">
                    <div className="text-3xl font-bold text-purple-500">
                      <CountUp end={25000} suffix="+" delay={200} />
                    </div>
                    <p className="text-gray-400">Monthly Readers</p>
                  </div>
                  <div className="space-y-2">
                    <div className="text-3xl font-bold text-purple-500">
                      <CountUp end={12} suffix="+" delay={400} />
                    </div>
                    <p className="text-gray-400">AI Topics Covered</p>
                  </div>
                  <div className="space-y-2">
                    <div className="text-3xl font-bold text-purple-500">
                      <CountUp end={99} suffix="%" delay={600} />
                    </div>
                    <p className="text-gray-400">Reader Satisfaction</p>
                  </div>
                </div>
              </div>
            </ScrollFade>
